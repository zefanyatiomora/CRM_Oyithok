...
{{-- Jika pasang ditemukan, tampilkan konfirmasi hapus --}}
@isset($pasang)
<form action="{{ route('pasang.delete', $pasang->pasangkirim_id) }}" method="POST" id="form-delete-pasang">
    @csrf
    @method('DELETE')
    <div id="modal-master" class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Konfirmasi Hapus pasang</h5>
            ...
            <div class="modal-body">
                ...
                <p>Apakah Anda yakin ingin menghapus pasang produk ini?</p>
                
                {{-- Menampilkan detail item yang akan dihapus --}}
                <div class="alert alert-light">
                    <strong>Produk:</strong> {{ $pasang->produk->produk_nama ?? 'N/A' }} <br>
                    <strong>Kuantitas:</strong> {{ $pasang->kuantitas }} {{ $pasang->produk->satuan ?? '' }}
                </div>
...
$(document).ready(function () {
    ...
    $("#form-delete-pasang").submit(function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // Reload isi modal utama (yang menampilkan daftar pasang)
