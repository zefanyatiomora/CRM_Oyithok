...
@else
    <form action="{{ url('/produk/' . $produk->produk_id . '/delete_ajax') }}" method="POST" id="form-delete-produk">
        @csrf
        @method('DELETE')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            ...
                            <td class="col-9">{{ $produk->kategori->kategori_nama }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Kode Produk :</th>
                            <td class="col-9">{{ $produk->produk_kode }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Nama Produk :</th>
                            <td class="col-9">{{ $produk->produk_nama }}</td>
                        </tr>
                    </table>
                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                ...
                                dataProduk.ajax.reload(); // Make sure this matches your DataTable instance for barang
                            } else {
                                $('.error-text').text('');
